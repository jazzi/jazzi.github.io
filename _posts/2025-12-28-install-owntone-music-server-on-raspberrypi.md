...
I want to use the third one, the USB DAC, according to the [OwnTone Documentation](https://owntone.github.io/owntone-server/advanced/outputs-alsa/), for the Audio Output two options available:

1. Alsa
2. Pulseaudio

I choose **ALSA**, hereby is the key lines from the documentation:
